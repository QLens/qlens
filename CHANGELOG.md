...
- `qlens.assert_distribution(result, expected)`: chi-square (discrete counts) and KS (continuous samples) validation of sampled output against an expected distribution.
